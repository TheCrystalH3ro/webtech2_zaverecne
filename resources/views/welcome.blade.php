    ...
    <div
        ...
        <div class="sm:fixed sm:top-0 sm:left-0 p-6 text-left z-10">
            <a href="{{ url('/language/en') }}"
                    class="@if(app()->isLocale('en')) active @endif font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">en</a>
            <a href="{{ url('/language/sk') }}"
                    class="@if(app()->isLocale('sk')) active @endif font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">sk</a>
        </div>
